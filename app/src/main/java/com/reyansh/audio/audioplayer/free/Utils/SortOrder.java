...
public final class SortOrder {
    ...
    public interface ArtistSortOrder {
        ...
        String ARTIST_NUMBER_OF_SONGS = MediaStore.Audio.Artists.NUMBER_OF_TRACKS
                + " DESC";
        /* Artist sort order number of songs */
        String ARTIST_NUMBER_OF_SONGS_ASC = MediaStore.Audio.Artists.NUMBER_OF_TRACKS
                + " ASC";
        /* Artist sort order number of albums */
        String ARTIST_NUMBER_OF_ALBUMS = MediaStore.Audio.Artists.NUMBER_OF_ALBUMS
                + " DESC";
        String ARTIST_NUMBER_OF_ALBUMS_ASC = MediaStore.Audio.Artists.NUMBER_OF_ALBUMS
                + " ASC";
    }
    ...
    public interface AlbumSortOrder {
        ...
        String ALBUM_NUMBER_OF_SONGS_DESC = MediaStore.Audio.Albums.NUMBER_OF_SONGS + " DESC";
        String ALBUM_NUMBER_OF_SONGS_ASC = MediaStore.Audio.Albums.NUMBER_OF_SONGS + " ASC";

        String ALBUM_ARTIST_ASC = MediaStore.Audio.Albums.ARTIST + " ASC";
        String ALBUM_ARTIST_DESC = MediaStore.Audio.Albums.ARTIST+" DESC";

        String ALBUM_YEAR_DESC = MediaStore.Audio.Albums.FIRST_YEAR + " DESC";
        String ALBUM_YEAR_ASC = MediaStore.Audio.Albums.FIRST_YEAR + " ASC";
    }
